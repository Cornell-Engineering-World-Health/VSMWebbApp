...
class UpdatesControllerTest < ActionController::TestCase
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post :create, update: { Condition: @update.Condition, Date: @update.Date, PatientID: @update.PatientID, Time: @update.Time }
    end
  ...
  test "should update update" do
    patch :update, id: @update, update: { Condition: @update.Condition, Date: @update.Date, PatientID: @update.PatientID, Time: @update.Time }
    assert_redirected_to update_path(assigns(:update))
  end
